...
| 009-submission-package | DoraHacks 提交材料 | 提交 | 已验证 | `feature/009-submission-package` | `docs/evidence/009-submission-package.md` | status、task-board、spec、README、architecture、PRD、demo-script、submission-checklist、readiness-audit、evidence、handoff、project-acceptance |
